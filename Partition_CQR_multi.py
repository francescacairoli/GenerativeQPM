...
class PartitionCQR():
	...
	def get_scores_threshold(self):
		...
		self.calibr_quantiles = self.get_pred_interval(self.cal_loader,extra='cal') # num_classes, nb_states, 2
	...
	def get_cpi(self, tloader, pi_flag = False):
		...
		pis = self.get_pred_interval(tloader,extra='test') #[n_points,n_classesm,2]
