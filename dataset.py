...
class Dataset(Dataset):
	def __init__(self, model_name, target_dim, eval_length, missing_ratio=0.0, seed=0, idx='', scaling_flag=False, extra_info = '', train_ds = None):
...
def get_dataloader(model_name, eval_length, target_dim, seed=1, nfold=None, batch_size=16, missing_ratio=0.1, scaling_flag = False, extra_info = ''):
